...
if __name__ == '__main__':
    ...
    product_url = "https://www.asus.com.cn/support/api/product.asmx/GetPDLevel?website=cn&type=1&typeid=155&productflag=0"
    ...
    try:
        ...
        products = product_dict['Result']['ProductLevel']['Products']['Items']  # 获得产品列表
